create database hi_mybatis default charset =utf8;
...
select t_employees.id,t_employees.name,t_employees.salary,t_departments.id deptId ,t_departments.name detpName,t_departments.location
...
select t_passengers.id,t_passengers.name,t_passengers.sex,t_passengers.birthday,t_passports.id passId,t_passports.nationality,t_passports.expire
 ...
 select t_passports.id,t_passports.nationality,t_passports.expire,t_passengers.id passenger_id,t_passengers.name,t_passengers.sex,t_passengers.birthday
